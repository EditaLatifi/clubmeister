...
const Blog = ({ posts }) => {
  ...
  {/* Title */}
  <h1 className="text-[52px] font-montserrat font-bold leading-[100%] text-[#0F172A]">
    Clubmister’s– <span className="text-[#6D011C]">Club World</span>
  </h1>

  {/* Subtitle */}
  <p className="text-[24px] font-poppins text-[#475467] leading-[150%] max-w-[940px]">
  ...
  <div className="flex items-center justify-center gap-[16px] mt-4">
    ...
    <input
      ...
      className="w-[479px] h-[59px] px-[20px] py-[20px] border border-[#D0D5DD] rounded-[8px] text-[16px] font-inter text-[#000] placeholder:text-[#667085] leading-[24px]"
    />
...
{/* Privacy Text */}
<div className="w-full max-w-[690px] text-left mt-[-12px]">
...
<section className="max-w-[1300px] mx-auto px-4 space-y-10 mt-[180px]">
  ...
  <div className="text-center space-y-2">
    ...
    <h2 className="text-[52px] font-montserrat font-bold leading-[120%] text-[#0F172A]">
  ...
  {/* Pagination */}
  <div className="flex justify-between items-center pt-10 text-[14px] text-[#475467]">
  {/* ← Previous */}
  <button className="flex items-center gap-2 font-[600]">
    <Image
      src="/arrow-left.svg"
      alt="Previous"
      width={16}
  ...
  <div className="flex gap-3">
    {[1, 2, 3, "...", 9, 10].map((n, i) => (
      <button
        key={i}
        className={`w-8 h-8 rounded-full font-[500] ${
          n === 1 ? "bg-[#F9FAFB] text-[#1D2939]" : "text-[#475467] hover:bg-[#F2F4F7]"
        }`}
      >
        {n}
      </button>
...
<section className="text-center space-y-6 pt-[180px]">
  <p className="text-[#6D011C] text-[24px] font-poppins font-medium leading-[36px]">Blogs</p>
  <h2 className="text-[52px] font-montserrat font-bold leading-[100%] text-[#0F172A]">
    Individuelle Dienstleistungen <br className="hidden md:block" /> für Ihren Verein
  </h2>

  <div className="mx-auto mt-10 space-y-5 max-w-[1300px]">
    {/* Row 1 */}
